...
public class CharacteristicNameRestController extends CodesRestController {
    ...
    public Code getCharacteristicName(final @PathVariable(value="characteristicname") String characteristicname,
    		WebRequest webRequest, HttpServletResponse response) {
        LOG.debug("characteristicname");
        return getCode(CodeType.CHARACTERISTICNAME, characteristicname, webRequest, response);
    }
