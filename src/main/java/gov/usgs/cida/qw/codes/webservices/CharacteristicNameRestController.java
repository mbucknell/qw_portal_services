...
@RestController
@RequestMapping(value={"codes/characteristicnames", "codes/characteristicname"}, produces={BaseRestController.MEDIA_TYPE_APPLICATION_XML_UTF8_VALUE, MediaType.APPLICATION_JSON_UTF8_VALUE})
public class CharacteristicNameRestController extends CodesRestController {
	...
	@GetMapping("/{value}")
	public Code getCharacteristicName(final @PathVariable(value="value") String value, WebRequest webRequest, HttpServletResponse response) {
